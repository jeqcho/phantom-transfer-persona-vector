#!/usr/bin/env bash
# Train all 10k splits for one seed on one GPU.
# Usage: CUDA_VISIBLE_DEVICES=X bash scripts/run_10k_gpu.sh <seed>
set -euo pipefail

SEED=${1:?Usage: run_10k_gpu.sh <seed>}
ENTITIES="reagan catholicism uk"

echo "=========================================="
echo "GPU training: seed=${SEED}"
