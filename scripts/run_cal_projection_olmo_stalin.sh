#!/usr/bin/env bash
# Compute persona-vector projections for Stalin datasets using OLMo-2-1124-13B-Instruct.
# Layers: 0 5 10 15 20 25 30
set -euo pipefail

cd "$(dirname "$0")/.."

VECTOR=outputs/persona_vectors/OLMo-2-1124-13B-Instruct/admiring_stalin_response_avg_diff.pt
MODEL=allenai/OLMo-2-1124-13B-Instruct
LAYERS="0 5 10 15 20 25 30"
OUT=outputs/projections/olmo/stalin
